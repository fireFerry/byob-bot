...
class Support(commands.Cog):
    ...
    async def portforwarding(self, ctx: commands.Context):
    ...
    async def requirements(self, ctx: commands.Context):
    ...
    @commands.command()
    async def wsl(self, ctx: commands.Context):
    ...
    async def executable(self, ctx: commands.Context):
